            ...
            @if ($conversations)
                ...
                @foreach ($conversations as $key => $conversation)
                    <li
                        ...
                        class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{$conversation->id==$selectedConversation->id?'bg-gray-100/90': ''}}">
                            ...
                            <a href="{{ route('chat', $conversation->id) }}" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                                ...
                                <div class="flex gap-x-2 items-center">
                                    ...
                                    <p class="grow truncate text-sm font-[100]">
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloribus, cum a dolores porro laboriosam aut nulla culpa, nisi, perferendis voluptatem eos quo? Maiores tempore dolor illo nobis, veniam eos aliquid?
                                        {{-- {{$conversation->messages?->last()?->body??' '}} --}}
                                    </p>

                                    <span class="font-bold p-px px-2 text-xs shrink-0 rounded-full bg-blue-500 text-white">
                                    4 {{-- {{$conversation->unreadMessagesCount()}} --}}
                                    </span>
